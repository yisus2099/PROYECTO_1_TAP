...
public class Credito {
    ...
    public Credito(String numCuenta, String numTarjeta, Double limCredito, Double tasaInteresAnual, Double anualidad, Fecha fechaCreacion, Fecha fechaCorte, Fecha fechaPago, Fecha fechaApliAnua) {
