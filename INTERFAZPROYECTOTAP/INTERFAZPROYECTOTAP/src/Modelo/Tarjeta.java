...
//Lista de movimientos
    ...
    public String toString() {
        return "Tarjeta{" + "numCuenta=" + numCuenta + ", numTarjeta=" + numTarjeta + ", limCredito=" + limCredito + ", tasaInteresAnual=" + tasaInteresAnual + ", anualidad=" + anualidad + ", fechaCreacion=" + fechaCreacion + ", fechaCorte=" + fechaCorte + ", fechaPago=" + fechaPago + ", fechaApliAnua=" + fechaApliAnua + '}';
    }
